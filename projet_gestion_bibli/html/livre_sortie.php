...
if(isset($_POST['emprunter'])){
    ...
    $requete="INSERT INTO `emprunter`(`PERSONNE_mat_pers`, `PERSONNE_GROUPE_code_grp`, `DOCUMENT_code_doc`, `date_sortie`, `date_retour`) value('$pers', '$pergrpcode','$doc','$date_sortie','0000-00-00');";
		...
		<form method="POST" action="" enctype="multipart/form-data">
			<table border="1" width="400px" cellpadding="10px" cellspacing="23px" align="center" valign="center">
				...
				<tr>
					...
					<input  class="btn btn-primary" type="submit" name="emprunter" value="emprunter" style="border-radius:10px;height:40px;width:170px"/>
