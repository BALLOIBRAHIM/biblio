 ...
 <a href="deconnexion.php">
  ...
  <div class="mySlides fade" >
    ...
    <div class="inde" style="margin-top: -2px; width:" >
      ...
      <li><a href="emprunter.php? mat_pers=<?php echo $_SESSION['mat_pers']?>" style="font-size: large;">emprunter livre</a></li>
...
<span class="baniere" style="margin-top: 20px;">
   ...
   <p style="text-align: center;font-size:xx-large;margin-top: 10px;">Les livres empruntés </p>
 
</span>
<span class="baniere" style="margin-top: 20px;background-color:rgb(166, 167, 164); height: 350px;overflow:scroll;">
          <?php include'lbemprunter.php'?>
          </span>
  

<span class="baniere"><p style="text-align: center;font-size:xx-large;margin-top: 10px;">Les livres retournés</p></span>
          
          <!--les livre les plus empruntés -->
          <span class="baniere" style="margin-top: 20px;background-color:rgb(166, 167, 164); height: 350px;overflow:scroll;">
          <?php include'retour_emprunter.php'?>
