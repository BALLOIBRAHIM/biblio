 ...
 <a href="deconnexion.php">
  ...
  <div class="mySlides fade" >
    ...
    <div class="inde" style="margin-top: -2px; width:" >
      <ul> 
        <li><a href="#" style="font-size: large;">Accueil</a></li>
        <li><a href="emprunter.php? mat_pers=<?php echo $_SESSION['mat_pers']?>" style="font-size: large;width:190px">les livre disponibles</a></li>
        <li><a href="gestion_emprunts.php? mat_pers=<?php echo $_SESSION['mat_pers']?>" style="font-size: large;">gérer emprunts</a></li>
